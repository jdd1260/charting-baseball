...
This is a data visualization project that explores the question of "Who is the best baseball player?" Using d3 and data from FanGraphs the user is guided through a series of charts before being allowed to freely explore the data. This is known as a martini glass visualization. See it in action [here](https://jdd1260.github.io/charting-baseball/).
